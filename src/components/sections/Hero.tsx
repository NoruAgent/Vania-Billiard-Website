  ...
  return (
    <section className="relative min-h-[100svh] lg:min-h-[92vh] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 h-full min-h-[60vh] md:min-h-[92vh] flex flex-col justify-center px-6 md:px-12 lg:px-20 py-16 md:py-0 relative z-10">
        <div className="w-12 h-px bg-copper mb-6 md:mb-8" />

        <p className="font-mono text-[10px] md:text-xs uppercase tracking-[0.3em] text-copper mb-6 md:mb-8">
          Workshop Ambarawa · Sejak 2014
        </p>

        <h1 className="font-serif text-4xl md:text-5xl lg:text-[5.5rem] font-medium leading-[1.02] mb-6 md:mb-8 text-white">
          Seni Presisi
          <br />
        ...
        <p className="font-light text-text-secondary text-sm md:text-base leading-relaxed max-w-md mb-8 md:mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
          ...
          <Link
            href="/meja-billiard"
            className="text-xs uppercase tracking-[0.2em] font-semibold flex items-center group text-text-secondary hover:text-copper transition-colors"
          >
            Lihat Koleksi Meja
      ...
      <div className="w-full md:w-1/2 h-[60vh] md:h-[92vh] relative bg-[#0e0e0e] overflow-hidden group">
        <img
          ...
          className="absolute inset-0 w-full h-full object-cover opacity-70 group-hover:opacity-90 transition-opacity duration-700 scale-105"
          loading="eager"
        />
        ...
        <div className="absolute top-[58%] left-[42%] z-20 hidden md:block group/hs">
          ...
          <div className="absolute hidden group-hover/hs:block bottom-8 -left-20 w-56 bg-[#141414] p-4 border border-copper/30 shadow-2xl pointer-events-none">
        ...
        <div className="absolute top-[28%] right-[18%] z-20 hidden md:block group/hs">
          <div className="w-4 h-4 bg-copper rounded-full animate-ping absolute opacity-60" />
          <div className="w-4 h-4 bg-copper border-2 border-white rounded-full relative cursor-pointer shadow-[0_0_10px_#C86A36]" />
          <div className="absolute hidden group-hover/hs:block bottom-8 -right-12 w-56 bg-[#141414] p-4 border border-copper/30 shadow-2xl pointer-events-none">
            <p className="text-[10px] uppercase tracking-widest text-copper font-bold mb-1">
              Solid Slate
            </p>
            <p className="text-[10px] text-text-secondary leading-relaxed">
